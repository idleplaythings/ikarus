...
depots_create_town = {
	...
	_numberOfDepots = call depots_getAmountOfTownDepots;
...
depots_create_supply = {
	...
	_numberOfDepots = call depots_getAmountOfSupplyDepots;
...
depots_getAmountOfSupplyDepots = {
	call objective_supply_getAmountOfDepots;
};

depots_getRadiusOfSupplyAO = {
  (call depots_getAmountOfSupplyDepots) * 0.5 * 1000;
};
